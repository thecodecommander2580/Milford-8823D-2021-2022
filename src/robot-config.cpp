...
pot autonSelect = pot(Brain.ThreeWirePort.G);
digital_out claw = digital_out(Brain.ThreeWirePort.C);
motor frontLeftBase = motor(PORT11, ratio18_1, false);
motor centerLeftBase = motor(PORT12, ratio18_1, false);
motor backLeftBase = motor(PORT13, ratio18_1, false);
motor frontRightBase = motor(PORT14, ratio18_1, false);
motor centerRightBase = motor(PORT15, ratio18_1, false);
motor backRightBase = motor(PORT16, ratio18_1, false);
